...
enum PacketType		
{
	ZB_IO, ZB_TRANSMIT_REQUEST, ZB_LIBEL_IO, ZB_LIBEL_REQUEST_IO, ZB_LIBEL_CHANGEFREQ, ZB_LIBEL_CHANGENODEFREQ, ZB_LIBEL_CHANGEFREQ_REPLY, ZB_LIBEL_ADDNODE, ZB_LIBEL_ADDNODE_REPLY,  WS_COMMAND, IPSUM_UPLOAD,
